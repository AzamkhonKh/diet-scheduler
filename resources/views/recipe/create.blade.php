                        ...
                        <div class="col-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-product-name">Ouput Unit</label>
                                        <input type="text" class="form-control" id="ecommerce-product-name"
                                            placeholder="Product title" name="name" aria-label="Product title" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="ecommerce-product-name">Ouput Amount</label>
                                        <input type="number" class="form-control" id="ecommerce-product-name"
                                            placeholder="Product title" name="name" aria-label="12" />
                                    </div>
                                    <!-- Description -->
                                    <div>
                                        ...
                                        <div class="form-control p-0 pt-1">
                                            ...
                                            <input type="hidden" name="comment" id="quil-replicate" value="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form class="form-repeater">
                                        ...
                                        <div>
                                            <button class="btn btn-primary" data-repeater-create>Add another
                                                option</button>
                                        </div>
                                    </form>
                                </div>
